...
{\color{red} Not sure if the SC FC plot should rather go into methods with the atlas plot.}
\begin{figure*}
    \centering
    \includegraphics[width=\textwidth]{../project_SOCS_code/figures/averaged_sc_fc.png}
...
\begin{figure}
    \centering
    \includegraphics[width=0.9\linewidth]{../project_SOCS_code/figures/averaged_k_dist_matrices.png}
...
\begin{figure*}
    \centering
    \includegraphics[width=\textwidth]{../project_SOCS_code/figures/k_dist_correlation_vs_k.png}
...
\begin{figure}
    \centering
    \includegraphics[width=\linewidth]{../project_SOCS_code/figures/parameter_optimisation.png}
...
\begin{figure*}
    \centering
    \includegraphics[width=\textwidth]{../project_SOCS_code/figures/simulation_correlation_vs_k.png}
...
\begin{figure}
    \centering
    \includegraphics[width=0.9\linewidth]{../project_SOCS_code/figures/averaged_simulated_fc_matrices.png}
...
\begin{figure}
    \centering
    \includegraphics[width=0.9\linewidth]{../project_SOCS_code/figures/best_k_histograms.png}
